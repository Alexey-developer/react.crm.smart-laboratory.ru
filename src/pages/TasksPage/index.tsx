...
export const TasksPage: React.FC = () => {
  ...
  project.tasks.map((task, i) => {
    cardActions.push([
      ...
      />,
      <Link
        to={pathname + '/' + (task.id + i) + '/' + constants.routes.editing}
      >
        <ActionButton
  ...
  const tasksView = (
    <>
      <Filter
        ...
        //   {
        //     key: '1',
        //     label: translated_phrase('Filters.statuses'),
        //     children: [
        //       {
        //         key: '1-1',
        //         label: (
        ...
        //   {
        //     key: '2',
        //     label: translated_phrase('MenuItems.projects'),
        //     children: [
        //       {
        //         key: '2-1',
        //         label: (
      ...
      <Radio.Group name='radiogroup' defaultValue={viewType === 'list' ? 1 : 2}>
        <Dropdown menu={menuProps} placement='bottom' arrow>
          <Button>
            {/* <Space> */}
            Вид <i className='fa-regular fa-table-cells'></i>
            {/* </Space> */}
          </Button>
        </Dropdown>
      </Radio.Group>
